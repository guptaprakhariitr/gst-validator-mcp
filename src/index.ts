...
const SERVER_INFO = { name: "gst-validator-mcp", version: "0.1.0" };
...
const LLMS_TXT = `# gst-validator-mcp
...
const LANDING = `<!doctype html><html><head><meta charset="utf-8"><title>gst-validator-mcp</title>
...
<body><h1>gst-validator-mcp</h1>
<p>Validate Indian GSTIN numbers for AI agents — structure, state code, embedded PAN, and GSTN mod-36 check character.</p>
